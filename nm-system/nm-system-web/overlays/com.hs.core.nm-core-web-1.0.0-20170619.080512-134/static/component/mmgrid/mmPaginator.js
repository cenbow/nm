!function($){
    ...
    MMPaginator.prototype = {
        _initLayout: function(){
            ...
            var pgHtmls = [
                '<div class="totalCountLabel pagination "></div>',
                '<ul class="pageList pagination pagination-sm"></ul>',
                '<div class="limit pagination "><select class="form-controller"></select></div>'
            ];
        ...
        , load: function(params){
            ...
            this.$totalCountLabel.html(this.formatString(opts.totalCountLabel,[totalCount, pageFirst, pageTotal]));
            this.$pageList.empty();
