...
!function($){
    ...
    $.fn.mmGrid.defaults = {
        ...
        , events: {
            loadSuccess : function (event, data) {

            },
            loadError: function (event, data) {

            },
            cellSelected: function (event, item, rowIndex, colIndex) {

            },
            rowInserted: function (event,item, rowIndex){

            },
            rowUpdated: function (event, oldItem, newItem, rowIndex) {

            },
            rowRemoved: function (event, item, rowIndex){
