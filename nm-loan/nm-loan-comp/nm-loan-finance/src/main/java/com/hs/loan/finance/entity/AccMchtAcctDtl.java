 ...
 * @create 2016-02-03
 */
public class AccMchtAcctDtl implements Serializable{
	 ...
	 * @param drCrFlalg
	 */
	public void setDrCrFlalg(String drCrFlalg) {
		this.drCrFlalg = drCrFlalg;
	}
	 ...
	 * @param cntCustNo
	 */
	public void setCntCustNo(String cntCustNo) {
		this.cntCustNo = cntCustNo;
	}
