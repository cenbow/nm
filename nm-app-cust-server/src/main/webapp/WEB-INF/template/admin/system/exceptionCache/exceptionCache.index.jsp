...
<head>
	...
	<title>用户管理</title>
	<script type="text/javascript">Global( "resources/admin/system/exceptionCache/static/exceptionCache.index", {} );</script>
</head>
<body>
	<div class="container-fluid">
		<div class="grid-query">
			<input type="text" class="input"  name="errorCode" data-options="{txtPrefix: '错误码'}" />
			<div class="input">
