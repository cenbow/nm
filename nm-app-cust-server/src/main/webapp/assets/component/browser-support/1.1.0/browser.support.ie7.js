( function (){ 
	...
	if ( typeof require == "function" ) require( [ "jquery" ], function( $ ) { support( $ ); } );
	else {
		if ( typeof window.jQuery == "undefined" ) throw new Error( "required jQuery support." );
		support( window.jQuery );
	}
